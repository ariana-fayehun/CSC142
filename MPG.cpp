...
int main(){   
    ...
    std::cout<<"Please enter the name of your car: ";
    ...
    mpg = miles / gallons;
    // lkm = 235.215 / mpg;
    lkm = (100 / (mpg * KM_PER_MILE)) * LITERS_PER_GALLON;
    ...
    std::cout<<"Your fuel efficiency is " << mpg << " miles per gallon, or " << lkm << " liters per 100 kilometers."<<std::endl;
