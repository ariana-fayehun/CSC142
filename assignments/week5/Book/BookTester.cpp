...
int main() {
    ...
    printf("%-13s %-16s %-43.40s %2d %3s $%8.2f\n", 
        book1.getISBN().c_str(), book1.getAuthor().c_str(), book1.getTitle().c_str(), 
        book1.getEdition(), book1.getPubCode().c_str(), book1.getPrice());
    
    printf("%-13s %-16s %-43.40s %2d %3s $%8.2f\n", 
        book2.getISBN().c_str(), book2.getAuthor().c_str(), book2.getTitle().c_str(), 
        book2.getEdition(), book2.getPubCode().c_str(), book2.getPrice());
    
    printf("%-13s %-16s %-43.40s %2d %3s $%8.2f\n", 
        book3.getISBN().c_str(), book3.getAuthor().c_str(), book3.getTitle().c_str(), 
        book3.getEdition(), book3.getPubCode().c_str(), book3.getPrice());
        std::cout << "-----------------------------------------------------------------------------------------" << std::endl;
